...
import static com.exmaple.tencentqq.domain.Cheeses.NAMES;
...
import com.exmaple.tencentqq.reminder.GooViewListener;
import com.exmaple.tencentqq.swipe.SwipeLayout.SwipeListener;
...
public class SwipeListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		ViewPropertyAnimator.animate(view).rotationX(0).setDuration(600).setInterpolator(new OvershootInterpolator(8)).start();
		ViewHelper.setScaleX(view, 0.4f);
		ViewPropertyAnimator.animate(view).scaleX(1f).setDuration(600).setInterpolator(new OvershootInterpolator(8)).start();
		return view;
	}
